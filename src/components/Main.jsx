...
const Main = () => {
  return (
    <main>
      <div className="bg-cover bg-center text-white text-center flex flex-col justify-end items-start background-image-main transition-transform duration-400 ease-in-out hover:transform hover:scale-90">
        <h1 className="font-poppins text-4xl font-bold mb-4">.</h1>
      </div>
        ...
        <ul className="flex ">
          <li className="w-1/4">
            <div className="flex items-center justify-center">
              <img
                src="\src\assets\Footer_Icons-08_275x.avif"
          ...
          <li className="w-1/4">
            <div className="flex items-center justify-center">
              <img
                src="\src\assets\Footer_Icons-07_275x.avif"
                alt="0% APR available"
                className="w-32 h-32"
              />
              <div>
          ...
          <li className="w-1/4">
            <div className="flex items-center justify-center">
              <img
                src="\src\assets\Footer_Icons-06_275x.avif"
          ...
          <li className="w-1/4">
            <div className="flex items-center justify-center">
              <img
                src="\src\assets\Footer_Icons-05_275x.avif"
        ...
        <div className="flex items-center justify-center mt-4 pb-12">
          <div className="relative " style={{ width: "700px" }}>
            ...
            <div className="absolute right-2 top-1/2 transform -translate-y-1/2">
              <svg
                className="w-15 h-3 text-yellow-300"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 69 15"
